...
<meta name="Generator" content="www.torpix.net" />
<script>
...
#instr_header {
	background: url('/pics/boletos/empresa.png') no-repeat top left;
	padding-left: 160px;
	height: 65px;
}
...
<!--
 ...
 -->
	...
	<div id="boleto">
		...
		<tbody>
		<tr>
			<td width=150><IMG SRC="pics/boletos/logobancoob.jpg"></td>
			<td width=50>
